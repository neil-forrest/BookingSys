...
{
 $calendar = new UnlimitedBookings();
echo'<div class="container"><div id="CreateDatePicker" class="row">';       
$calendar->CreateDatepicker(10);
echo'</div><div class="row"><form action="details.php" method="POST">
...
<tr><td>Telephone:  </td><td><input type="text" name="phone" value=""></td></tr>    
<tr><td>Address (line 1): </td><td> <input type="text" name="address1" value=""></td></tr>
<tr><td>Address (line 2):</td><td><input type="text" name="address2" value=""></td></tr>
<tr><td>Address (line 3):</td><td><input type="text" name="address3" value=""></td></tr>
<tr><td>Town\City: </td><td><input type="text" name="city" value=""></td></tr>
